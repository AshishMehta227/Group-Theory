...
#include<stdlib.h>
#include<time.h>
char fnclosure(char op,int values,int a[],int m);
char fnassociative(char op,int values,int a[],int m);
int fnidentity(char op,int values,int a[],int m);
char fninverse(char op,int n,int a[],int m,int c3);
int search(int val,int n,int a[]);
int order(char op,int n,int mod,int c3);
...
char fnclosure(char op,int values,int a[],int mod)
{
	char r='y';
	int c;
	if(op=='+')
...
char fnassociative(char op,int values,int a[],int mod)
{
	char g='y';
...
int fnidentity(char op,int values,int a[],int mod)
{
...
char fninverse(char op,int n,int a[],int mod,int c3)
{
    char r='y';
    if(op=='+')
    {
